...
UserSchema.pre('save', function () {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    fields = this.modifiedPaths().reduce(function (previous, current) {
                        previous[current] = _this.get(current);
                        return previous;
                    }, {});
                    return [4 /*yield*/, __1.hooks.beforeUserUpdate.invokeAsync(this._id, fields)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }

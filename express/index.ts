...
import { authenticate, getOnlineFriends, sendFriendRequest, connectDatabase, getFriends, getFriendRequests, getFriendRequestsProfile, consumeFriendRequest, assignDeviceToUser, pingUser, blockUser, unblockUser, updateUser, getOnlineUserCount, getConversations } from "../src";
...
/////Conversations
friend.get("/conversations", async (req,res) => {
    tryOrErr(res, async () => {        
        res.json(await getConversations(req.cauth._id));
    }, 500);
});
